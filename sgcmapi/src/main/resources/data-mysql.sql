...
INSERT INTO `atendimento` (`id`, `data`, `hora`, `status`, `convenio_id`, `paciente_id`, `profissional_id`) VALUES
    (1,'2024-10-18','14:00:00','AGENDADO',1,1,1),
    (2,'2024-10-18','14:30:00','AGENDADO',2,2,2),
    (3,'2024-11-01','14:30:00','ATENDIMENTO',3,3,3),
    (4,'2024-11-01','15:00:00','CHEGADA',1,4,4),
    (5,'2024-11-01','15:00:00','CONFIRMADO',2,1,1),
    (6,'2024-11-01','16:00:00','AGENDADO',NULL,2,1),
    (7,'2024-11-01','15:30:00','AGENDADO',1,3,2),
    (8,'2024-11-01','16:30:00','AGENDADO',2,4,2),
    (9,'2024-11-02','17:00:00','AGENDADO',3,5,5),
    (10,'2024-10-25','17:30:00','AGENDADO',1,2,3),
    (11,'2024-10-25','18:00:00','AGENDADO',3,2,1),
    (12,'2024-10-25','17:00:00','AGENDADO',1,3,5);
...
INSERT INTO `usuario` (`id`, `ativo`, `nome_completo`, `nome_usuario`, `papel`, `senha`) VALUES
    ...
    (4,b'1','Limeira','limeira','ATENDENTE','limeira');
